    ...
    const fetchDashboardData = async () => {
        try {
            ...
            const [overviewRes, revenueRes, topProductsRes, recentOrdersRes] = await Promise.all([
                fetch('https://be-qlda.onrender.com/api/stats/overview', { headers }),
                fetch(`https://be-qlda.onrender.com/api/stats/revenue-chart?days=${chartPeriod}`, { headers }),
                fetch('https://be-qlda.onrender.com/api/stats/top-products?limit=5', { headers }),
                fetch('https://be-qlda.onrender.com/api/stats/recent-orders?limit=5', { headers })
            ]);
                        ...
                        <div className="top-products-list">
                            {topProducts.length > 0 ? topProducts.map((item) => (
                                <div key={item.product.id} className="product-item">
                                    ...
                                    <img
                                        src={`https://be-qlda.onrender.com${item.product.image}`}
